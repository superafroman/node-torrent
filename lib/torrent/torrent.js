...
var torrent = client.addTorrent('magnet:?xt=urn:btih:30f2f39908d7167181de1ea05a56d67c6acf281d&dn=Silver.Linings.Playbook.2012.DVDRIP-EDAW2013&tr=udp%3A%2F%2Ftracker.openbittorrent.com%3A80&tr=udp%3A%2F%2Ftracker.publicbt.com%3A80&tr=udp%3A%2F%2Ftracker.istole.it%3A6969&tr=udp%3A%2F%2Ftracker.ccc.de%3A80');
...
Torrent.prototype.addPeer = function(/* peer | id, address, port */) {
  ...
  if (!(peer.getIdentifier() in this.peers)) {
    ...
    peer.once(Peer.DISCONNECT, function() {
      ...
      requestStrategy.peerDisconnected(peer);
    ...
    peer.on(Peer.READY, function() {
      requestStrategy.peerReady(peer);
    });
