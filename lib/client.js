...
Client.prototype.addTorrent = function(url) {
  var torrent = new Torrent(this.id, this.port, this.downloadPath, url);
  var client = this;
  // TODO: if errors READY will never emit, should add to client.torrents once we know the
  // infoHash
  torrent.once(Torrent.READY, function() {
